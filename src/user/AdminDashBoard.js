...
function AdminDashBoard() {
        ...
        return (
            <div className="card">
                ...
                <ul className="list-group">
                    ...
                    <li className="list-group-item">
                        <Link to="/admin/categories" className="nav-link text-success">Manage Categoies</Link>
                    </li>
                    <li className="list-group-item">
    ...
    return (
        <Base title="Welcome to Admin DashBoard" description="Manage all the products here" className="container bg-success p-4" >
            <div className="row">
